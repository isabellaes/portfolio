          ...
          <div className="main-row">
            ...
            <div className="box-column-50">
              ...
              <p>
                ...
                butik. Jag är utbildad systemutvecklare, tog examen våren 2023
                och studerar nu till frontendutvecklare React. Mitt intresse för
                programmering började ganska tidigt när jag i ungdomen höll på
                en del med css och html. Har alltid velat lära mig att bygga
                hemsidor men det tog några år innan jag sökte mig in till
                programmering. Jag har alltid tyckt om problemlösning och
                matematik. Jag började studera till systemutvecklare hösten 2021
                och läste då mestadels C# och .Net. Det bästa med
                ...
                alltid får utforska inom programmering.
              </p>
