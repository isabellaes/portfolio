  ...
  return (
    <div className="main-row">
      <div className="box-column-50">
        ...
        <p>
          Bra på problemlösning och logiskt tänkande. Driven. Tycker om att lära
          mig nya saker.
        </p>
      </div>
      <div className="box-column-50">
        ...
        <p>
          ...
          år innan jag sökte mig in till programmering. Jag har alltid tyckt om
          problemlösning och matematik. Jag började studera till
          ...
          saker. Jag tycker också om att lära mig nya saker och det är något jag
